...
@interface MWOutputWinController : NSWindowController <MWOutputWinController, MWLinkable, NSUserInterfaceValidations, MWExtInputClient, MWHasMutableConfig, MWTerminalPaneDelegate> {
  ...
  IBOutlet MWTerminalPane *terminalPane;
}
